...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Bienvenido, este programa calcurá cuantos metros cubicos cada 'x' horas salen de los pozos");
		...
		/*
		 * Pasamos los litros a m3 haciendo: 8L= 1/1000m3 luego pasamos los m3 a m3h
		 * haciendo: m3*sec (antes declaramos los segundos que son 3600) por ultimo para
		 * saber el total sería m3h*horas que vamos a estar sacando agua.
		 */
		m3 = caudal / den;
		m3h = m3 * sec;
		total = m3h * horas;
