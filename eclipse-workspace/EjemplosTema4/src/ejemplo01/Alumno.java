...
public class Alumno extends Persona {
	...
	public String toString() {
		return super.toString() + "Alumno [matriculado=" + Arrays.toString(matriculado) + ", clase=" + clase
				+ ", notaMedia=" + notaMedia + "]";
	}

	/*
	 * @Override public String toString() { return "Alumno [matriculado=" +
	 * Arrays.toString(matriculado) + ", clase=" + clase + ", notaMedia=" +
	 * notaMedia + "]"; }
	 */

	// El toString sin darle a inherited solo muestra los atributos de alumno. Los
	// de la madre no
